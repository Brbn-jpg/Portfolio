  ...
  timeline: {
    ...
    entries: {
      ...
      yearFour: {
        ...
        body: "I defended my Engineering Thesis in the final year of my Computer Science degree, then built 'Gamelog', a full-stack game backlog manager where I mastered Redis for high-performance data caching, and explored the intersection of backend and AI with 'LlamaTalks' – integrating LLMs (LangChain) with Java-based systems and vector databases.",
      },
      present: {
        title: "Present: Professional Career (Since 2026)",
        body: "Since June 2026 I've been a Junior Java Developer at Netcompany. I apply my engineering foundations to complex, large-scale systems while continuing to explore cutting-edge technologies like RAG and DevOps in my personal time.",
      },
      future: {
  ...
  faq: {
    ...
    items: {
      ...
      whyBrbnJpg: {
        ...
        answer:
          "They're the same person — me. I've used the handle brbn-jpg online for years, and it's the name of my GitHub account — the handle is on github.com/Brbn-jpg, the name is on my CV.",
      },
